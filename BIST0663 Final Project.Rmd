...
```{r}
ALZH_noID<-ALZH_noID[-34]
n <-nrow(ALZH)
train <-ALZH[1:1075,-c(1,35)]
test <- ALZH[1075:2149,-33]
test_y <-ALZH[1075:2149,33]

train_x <-ALZH[1:1075,-c(1,34,35)]
train_y <-ALZH[1:1075,34]
test <- ALZH[1075:2149,-c(1,34,35)]
test_y <-ALZH[1075:2149,-c(1,35)]
x <-model.matrix(Diagnosis~.,data=ALZH_noID)[,-33]
